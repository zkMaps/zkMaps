...
/*
AssertFixedLocation
maxLatitude=12973547807205027
maxLongitude=7501387182542445
minLatitude=12973227978507761
minLongitude=7500977777251778
*/
void AssertFixedLocation_fad4407af0d60f2a(Circom_CalcWit *ctx, int __cIdx) {
...
minLongitude=7500977777251778
*/
void AssertInLocation_72aac50f8db4b751(Circom_CalcWit *ctx, int __cIdx) {
    FrElement _sigValue[1];
    FrElement _sigValue_1[1];
...
Circom_ComponentFunction _functionTable[4] = {
     AssertFixedLocation_fad4407af0d60f2a
    ,AssertInLocation_72aac50f8db4b751
